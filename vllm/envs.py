...
if TYPE_CHECKING:
    ...
    VLLM_DFLASH_CALIBRATION_LOG_INTERVAL: int = 0
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Quantize modelopt-excluded linear layers whose module prefix contains
    # this substring (e.g. "self_attn") to FP8 online at load time, instead
    ...
    # Completed DFlash target passes per calibration summary. Zero disables it.
    "VLLM_DFLASH_CALIBRATION_LOG_INTERVAL": lambda: int(
        os.getenv("VLLM_DFLASH_CALIBRATION_LOG_INTERVAL", "0")
    ),
