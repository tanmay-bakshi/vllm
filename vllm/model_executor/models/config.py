...
class Gemma4Config(VerifyAndUpdateConfig):
    ...
    def verify_and_update_config(vllm_config: "VllmConfig") -> None:
        ...
        Gemma4 multimodal checkpoints combine 256-wide sliding text heads,
        512-wide full text heads, and 72-wide vision heads. Text attention can
        use the Gemma4 FlashInfer TRTLLM-GEN override when the checkpoint and
        runtime are compatible, while the global backend remains TRITON_ATTN
        so unsupported non-text attention keeps a valid implementation.
        """
        hf_text_config = vllm_config.model_config.hf_text_config
        ...
        if (
            ...
            logger.info(
                ...
                "FLASHINFER_GEMMA4_TRTLLM_GEN rejection reasons: %s.",
                head_dim,
                global_head_dim,
