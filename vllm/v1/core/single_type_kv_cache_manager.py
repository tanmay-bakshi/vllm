...
class SingleTypeKVCacheManager(ABC):
    ...
    def remove_skipped_blocks(
        ...
        Args:
            request_id: The request ID.
            processed_computed_tokens: Computed-token prefix containing only
                work whose model output has settled.
...
class RSWAManager(FullAttentionManager):
    ...
    def remove_skipped_blocks(
        ...
        window_start = max(
            num_prompt_tokens,
            processed_computed_tokens - self.rswa_window,
        )
...
def get_manager_for_kv_cache_spec(
    ...
    **kwargs,
    ...
    Args:
        ...
        max_in_flight_tokens: Maximum scheduled tokens whose outputs may not
            yet be settled.
